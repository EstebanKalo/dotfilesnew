 ...
 *
 * tests/fileHandlingTest.h.  Generated from fileHandlingTest.h.in by configure.
 */
...
#define SRCDIR_DEF "/home/esteban/Escritorio/hack_the_box/machines/administrator/tools/ntpdate/src/ntp-4.2.8p18/sntp/tests/data/";
